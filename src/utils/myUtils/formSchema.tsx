...
export const NewPersonSchema = Yup.object().shape({
    ...
    surname: Yup.string()
        ...
        .max(30, 'Nahname darf maximal 30 Zeichen lang sein'),
    title1: Yup.string()
        .max(34, 'Berufname darf maximal 34 Zeichen lang sein'),
    title2: Yup.string()
        .max(34, 'Berufname darf maximal 34 Zeichen lang sein'),
    job1: Yup.string()
        .max(25, 'Aufgabename darf maximal 25 Zeichen lang sein'),
    job2: Yup.string()
        .max(25, 'Aufgabename darf maximal 25 Zeichen lang sein'),
