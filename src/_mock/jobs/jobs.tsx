...
export const jobs: Job[] = [
    {
        ...
        skils: ['BIM Kentnisse - All-Plann/ Revit',],
    ...
    },
    {
        ...
        skils: ['Erfahrung in Bauleitung in Alpinregionen', 'BIM Kentnisse - All-Plann/ Revit', 'Gute psychologische überzeugungskraft ',],
        kontaktperson: 'Karolina Kantorska',
        tel: '+41 58 474 34 03',
        email: 'info@dima-partner.ch',
        id: '2'
    },
    {
        ...
        skils: ['erfarung mit Revit oder andere BIM Programmen', 'Kentniss von Baubewilligungsverfahren', 'gute organisatorische Fahigheiten', ' geschicktes umgang mit Bauherren und Behörden'],
        kontaktperson: 'Karolina Kantorska',
        tel: '+41 58 474 34 03',
        email: 'info@dima-partner.ch',
        id: '3'
